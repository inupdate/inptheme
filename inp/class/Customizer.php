	...
	protected function get_submenus() {
		...
		$label = array(
			...
			array(
				...
				'href'   => $revert_dashboard ? admin_url( $admin_page_url . 'jnews_import' ) : admin_url( $admin_url . '?page=jnews&path=demos' ),
			),
			array(
				'id'     => 'jnews_plugin',
				'parent' => 'jnews',
				'title'  => esc_html__( 'Install Plugin', 'jnews' ),
				'href'   => $revert_dashboard ? admin_url( $admin_page_url . 'jnews_plugin' ) : admin_url( $admin_url . '?page=jnews&path=plugin' ),
			),
			array(
				'id'     => 'jnews_customize',
				'parent' => 'jnews',
			...
			array(
				...
				'href'   => $revert_dashboard ? admin_url( $admin_page_url . 'jnews_system' ) : admin_url( $admin_url . '?page=jnews&path=system-status' ),
			),
			array(
				'id'     => 'jnews_documentation',
				'parent' => 'jnews',
				'title'  => esc_html__( 'Video Documentation', 'jnews' ),
				'href'   => $revert_dashboard ? admin_url( $admin_page_url . 'jnews_documentation' ) : admin_url( $admin_url . '?page=jnews&path=documentation' ),
			),
			array(
