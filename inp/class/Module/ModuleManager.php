...
class ModuleManager {
	...
	private function __construct() {
		...
		if ( $vc_editable || 'vc_inline' === $vc_action ) {
			...
			$this->do_shortcode();
		} elseif ( $pagenow === 'post.php' || $pagenow === 'post-new.php' || $pagenow === 'widgets.php' || $pagenow === 'admin-ajax.php' || $pagenow === 'customize.php' || ( $pagenow === 'admin.php' && isset( $_GET['page'] ) && $_GET['page'] === 'vc-roles' ) ) { //see FU3QZWHt
			$this->load_all_module_option();
		} else {
			$this->do_shortcode();
		}
